-- ============================================================
--  Quiniela Mundial 2026 — Vista admin del tablero de la liga
--  El admin (profiles.is_admin) ve TODOS los pronósticos ya
--  ingresados aunque el partido no haya empezado, en cualquier
--  liga. Ejecutar tras 0013. Aditiva (mismo tipo de retorno).
-- ============================================================
...
as $$
begin
  if not public.is_member(p_league) and not public.is_admin() then
